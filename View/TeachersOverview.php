    ...
    <div class="container">
        <table class="table table-striped table-dark">
                    ...
                    <td>
                        <form method='GET'>
                            ...
                            <button type="submit" name="id" class="btn btn-light"
                                    value="<?php echo $myTeacher['id']; ?>">more info
                            </button>
                        </form>
                    </td>
                    ...
                    <td>
                        <form method='GET'>
                            ...
                            <button type="submit" name="id" class="btn btn-secondary"
                                    value="<?php echo $myTeacher['id']; ?>">edit
                            </button>
                        </form>
                    </td>
                    <td>
                        <form method='POST'>
                            ...
                            <button type="submit" name="id" class="btn btn-danger"
                                    value="<?php echo $myTeacher['id']; ?>">delete
                            </button>
                        </form>
                    </td>
                    </th>
            ...
            <div class="extra-button">
                <button class="btn btn-primary"><a href="?page=teachers&create=">create new?</a></button>
                <button class="bth btn-primary"><a href="?page=teachers&export=CSV">Export as CSV</a></button>
            </div>
        </table>
    </div>
</section>
